...
export default function Hero() {
  ...
  return (
    <div
      className="flex items-center justify-center xl:block w-screen h-full bg-cover bg-center relative px-6 sm:px-16 xl:px-64"
      style={{
    ...
    >
      <div className="flex items-center justify-center xl:absolute top-1/3 text-white">
